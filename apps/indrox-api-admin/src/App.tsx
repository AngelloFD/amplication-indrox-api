...
import { AiUsageMetricList } from "./aiUsageMetric/AiUsageMetricList";
import { AiUsageMetricCreate } from "./aiUsageMetric/AiUsageMetricCreate";
import { AiUsageMetricEdit } from "./aiUsageMetric/AiUsageMetricEdit";
import { AiUsageMetricShow } from "./aiUsageMetric/AiUsageMetricShow";
  ...
  return (
    <div className="App">
      ...
      >
        ...
        <Resource
          name="AiUsageMetric"
          list={AiUsageMetricList}
          edit={AiUsageMetricEdit}
          create={AiUsageMetricCreate}
          show={AiUsageMetricShow}
        />
        <Resource
          name="Password"
          list={PasswordList}
